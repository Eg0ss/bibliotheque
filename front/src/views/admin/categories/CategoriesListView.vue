...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <RouterLink to="/admin/categories/nouvelle"
    ...
    <div v-else class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="cat in categoryStore.categories" :key="cat.id" class="hover:bg-gray-50 transition">
      ...
      <!-- Pagination -->
      <div v-if="categoryStore.pagination"
        ...
        <div class="flex gap-2">
          <button @click="goToPage(categoryStore.pagination.current_page - 1)"
